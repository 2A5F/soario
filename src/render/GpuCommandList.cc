...
namespace ccc
{
    ...
    //     if (CD3DX12_RESOURCE_BARRIER barrier; m_current_rt->require_state(
    //         *m_resource_owner, GpuRtState::RenderTarget, barrier
    //     ))
    //     {
    ...
    // {
    //     if (CD3DX12_RESOURCE_BARRIER barrier; rt->require_state(
    //         *m_resource_owner, GpuRtState::RenderTarget, barrier
    //     ))
    //     {
    //         m_command_list->ResourceBarrier(1, &barrier);
